...
module fui.room {
	...
	export class FUI_playerArea extends fairygui.GComponent {
		...
		public m_clickToBet:FUI_clickToBet;
		...
		protected constructFromXML(xml: any): void {
			...
			this.m_chipCount0 = <FUI_chipCount><any>(this.getChildAt(9));
			this.m_chipCount1 = <FUI_chipCount><any>(this.getChildAt(10));
			this.m_chipCount2 = <FUI_chipCount><any>(this.getChildAt(11));
			this.m_point1 = <FUI_cardsPoint2><any>(this.getChildAt(12));
			this.m_point2 = <FUI_cardsPoint1><any>(this.getChildAt(13));
			this.m_point0 = <FUI_cardsPoint1><any>(this.getChildAt(14));
			this.m_chipsList1 = <fairygui.GList><any>(this.getChildAt(15));
			this.m_chipsList0 = <fairygui.GList><any>(this.getChildAt(16));
			this.m_chipsList2 = <fairygui.GList><any>(this.getChildAt(17));
			this.m_clickToBet = <FUI_clickToBet><any>(this.getChildAt(18));
